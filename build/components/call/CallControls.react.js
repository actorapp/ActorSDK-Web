...
var CallControls = (function (_Component) {
  ...
  CallControls.prototype.render = function render() {
    var isOutgoing = this.props.isOutgoing;
    ...
    switch (this.props.callState) {
      case _ActorAppConstants.CallStates.CALLING:
        if (!isOutgoing) {
          mainControls.push(_react2.default.createElement(_AnswerButton2.default, { onClick: this.props.onAnswer, key: 'answer' }));
        }

        mainControls.push(_react2.default.createElement(_EndButton2.default, { onClick: this.props.onEnd, isOutgoing: isOutgoing, key: 'end' }));
        break;
      case _ActorAppConstants.CallStates.IN_PROGRESS:
      case _ActorAppConstants.CallStates.CONNECTING:
        secondaryControls.push([_react2.default.createElement(_FullScreenButton2.default, { onClick: this.props.onFullscreen, key: 'fullscreen' }), _react2.default.createElement(_MuteButton2.default, { onClick: this.props.onMuteToggle, key: 'mute' }), _react2.default.createElement(_VideoButton2.default, { onClick: this.props.onVideo, key: 'video' }), _react2.default.createElement(_AddUserButton2.default, { onClick: this.props.onUserAdd, key: 'add' })]);
        mainControls.push(_react2.default.createElement(_EndButton2.default, { onClick: this.props.onEnd, isOutgoing: isOutgoing, key: 'end' }));
        break;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'call__controls__icons row' },
