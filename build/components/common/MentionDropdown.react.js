...
var MentionDropdown = (function (_React$Component) {
  _inherits(MentionDropdown, _React$Component);
  ...
  _createClass(MentionDropdown, [{
    ...
    value: function render() {
      ...
      var mentionsElements = _.map(mentions, function (mention, index) {
...
MentionDropdown.propTypes = {
  mentions: _react2.default.PropTypes.array,
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.handleScroll = function (top) {
    var menuListNode = _react2.default.findDOMNode(_this3.refs.mentionList);
