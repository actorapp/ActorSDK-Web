  ...
  'messages': {
    ...
    'login': {
      ...
      'welcome': {
        ...
        'text': '<p>Siente la libertad de comunicar desde cualquier dispositivo, móvil, pc, mac o tablets desde cualquier lugar del mundo solo con conexión wifi, 3G o 4G.</p>' + '<p>Olvida para siempre el viejo correo electrónico y mensajes para tu negocio. {appName} plataforma centra todo en una sola aplicación.</p>'
      }
    },
    ...
    'members': '{numMembers, plural,' + '=0 {Sin Miembros}' + '=1 {# Miembro}' + 'other {# Miembros}' + '}',
    'kick': 'Expulsar',
