...
exports.default = {
  ...
  'messages': {
    ...
    'message': {
      ...
      'uploading': 'Загрузка...',
      'welcome': {
        'private': '<p>Это начало вашей приватной беседы с <strong>{name}</strong>.</p>' + '<p>Все сообщения доступны только вам двоим.</p>',
        'group': {
    ...
    'members': '{numMembers, plural,' + '=0 {Нет участников}' + '=1 {# участник} =2 {# участника} =3 {# участника} =4 {# участника}' + 'other {# участников}' + '}',
    'kick': 'Исключить',
